...
urlpatterns = [
    ...
    url('tomcat_project/UpdateStatus$', views.ProjectUpdateStatus),
    ...
    url('tomcat_url/UpdateStatus$', views.UrlUpdateStatus),
    url('tomcat_url/Add$', views.UrlAdd),
    url('tomcat_url/Delete$', views.UrlDelete),
    url('tomcat_url/CheckServer$', views.UrlCheckServer),
    url('mail/Query$', views.MailQuery),
    url('mail/UpdateMailStatus$', views.UpdateMailStatus),
    url('UpdateCheckStatus$', views.UpdateCheckStatus),
    url('^$', views.index),
